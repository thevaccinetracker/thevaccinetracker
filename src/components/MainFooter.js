          ...
          <div className="col-md-7">
            <div className="socialMediaIconsSection">
              ...
              <div className="socialMediaIcons facebookIcon">
                <a href="https://www.facebook.com/thevaccinetracker/" target="_blank" rel="noreferrer">
                  <img src={facebookIcon} alt="Open Facebook Page" className="img img-responsive"  />
                </a>
              </div>
              <div className="socialMediaIcons twitterIcon">
                <a href="https://twitter.com/TheVaccineTrakr" target="_blank" rel="noreferrer">
                  <img src={twitterIcon} alt="Open Twitter" className="img img-responsive"  />
                </a>
              </div>
              <div className="socialMediaIcons youtubeIcon">
                <a href="https://www.youtube.com/channel/UCtMJ_bX7VPUWoLXI_2mAUtQ" target="_blank" rel="noreferrer">
                  <img src={youtubeIcon} alt="Open Youtube" className="img img-responsive"  />
                </a>
              </div>
              <div className="socialMediaIcons producthuntIcon">
                <a href="https://www.producthunt.com/posts/covid-19-vaccine-tracker" target="_blank" rel="noreferrer">
                  <img src={producthuntIcon} alt="Open Producthunt" className="img img-responsive"  />
                </a>
              </div>
            </div>
          </div>
